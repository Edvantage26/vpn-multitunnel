...
function TunnelDetailPanel({
  ...
  return (
    <div className="space-y-4 relative">
      ...
      {/* DNS Issue Warning */}
      {status?.dnsIssue && (
        <div className="bg-yellow-900/30 border border-yellow-600 rounded-lg p-3 text-yellow-200 text-sm flex items-center gap-2">
          ...
          <span><span className="font-medium">DNS Issue:</span> {status.dnsIssue}</span>
        </div>
      )}
